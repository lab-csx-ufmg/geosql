					...
					<div id = "sobre">
						...
						<div class="container-fluid">
							<div class="row-fluid aligncenter">
								<p>
									Desenvolvido por <strong>Guilherme Henrique</strong>aluno da disciplina de Monografía em SI
									ministrada no Departamento de Ciência da
									Computadação da Universidade Federal de Minas Gerais. Este
									trabalho foi desenvolvido Sob orientação do professor
									Clodoveu Davis e para os próximos alunos da Disciplina de Banco de Dados Geograficos.
								</p>
								<p>
									Este site é um sistema com código aberto, sobre a licença GNU
									v2.
								</p>

								<p>O proposito do desenvolvimento é contar futuramente com a ação
